...
".\ap_wp_sidebar.cpp" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	..\abi\src\MSVC6_Release\bin\cdump.exe $(InputPath) g_pngSidebar > ./ap_wp_sidebar.cpp
...
".\ap_wp_sidebar.cpp" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	..\abi\src\MSVC6_Debug\bin\cdump.exe $(InputPath) g_pngSidebar > .\ap_wp_sidebar.cpp
...
".\ap_wp_splash.cpp" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	..\abi\src\MSVC6_Release\bin\cdump.exe $(InputPath) g_pngSplash > ./ap_wp_splash.cpp
...
".\ap_wp_splash.cpp" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	..\abi\src\MSVC6_Debug\bin\cdump.exe $(InputPath) g_pngSplash > .\ap_wp_splash.cpp
