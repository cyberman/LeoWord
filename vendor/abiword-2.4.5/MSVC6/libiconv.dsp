...
# PROP Output_Dir "..\abi\src\MSVC6_Debug\obj\libiconv"
# PROP Intermediate_Dir "..\abi\src\MSVC6_Debug\obj\libiconv"
# PROP Target_Dir ""
...
# ADD LIB32 /nologo /out:"..\abi\src\MSVC6_Debug\obj\libAbi_libiconv_s.lib"
...
# PROP Use_MFC 0
# PROP Use_Debug_Libraries 1
# PROP Output_Dir "..\abi\src\MSVC6_Release\obj\libiconv"
# PROP Intermediate_Dir "..\abi\src\MSVC6_Release\obj\libiconv"
# PROP Target_Dir ""
...
# ADD CPP /nologo /MD /W3 /Zi /O1 /Ob2 /I "..\libiconv" /I "..\libiconv\src" /I "..\libiconv\include" /I "..\libiconv\libcharset\include" /I "..\abi\src\af\gr\win" /I "..\abi\src\spell\other" /I "..\abi\src\af\xap\xp" /I "..\abi\src\af\xap\win" /I "..\abi\src\af\ev\xp" /I "..\abi\src\af\ev\win" /I "..\abi\src\af\util\xp" /I "..\abi\src\af\util\win" /I "..\abi\src\af\gr\xp" /I "..\wv" /I "..\wv\libole2" /I "..\wv\glib-wv" /I "..\expat\lib" /D "NDEBUG" /D "_X86_" /D "WIN32" /D HAVE_STRING_H=1 /D "BUILDING_LIBCHARSET" /GF /c
# SUBTRACT CPP /Fr
# ADD BASE RSC /l 0x41d
# ADD RSC /l 0x41d
BSC32=bscmake.exe
...
# ADD BSC32 /nologo
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo /out:"..\abi\src\MSVC6_Debug\obj\libAbi_libiconv_s.lib"
# ADD LIB32 /nologo /out:"..\abi\src\MSVC6_Release\obj\libAbi_libiconv_s.lib"
...
DEP_CPP_LOCAL=\
	"..\libiconv\libcharset\lib\relocatable.h"\
	
NODEP_CPP_LOCAL=\
	"..\libiconv\libcharset\lib\localcharset.h"\
...
# PROP Default_Filter "*.in;*.msvc*"
# Begin Source File

SOURCE=..\libiconv\lib\config.h.msvc

!IF  "$(CFG)" == "libiconv - Win32 Debug"

# Begin Custom Build
InputPath=..\libiconv\lib\config.h.msvc

"..\libiconv\lib\config.h" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy ..\libiconv\lib\config.h.msvc ..\libiconv\lib\config.h
...
SOURCE="..\libiconv\include\iconv.h.msvc-static"

!IF  "$(CFG)" == "libiconv - Win32 Debug"

# Begin Custom Build
InputPath="..\libiconv\include\iconv.h.msvc-static"

"..\libiconv\include\iconv.h" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy ..\libiconv\include\iconv.h.msvc-static ..\libiconv\include\iconv.h
...
SOURCE=..\libiconv\libcharset\include\libcharset.h.in

!IF  "$(CFG)" == "libiconv - Win32 Debug"

# Begin Custom Build
InputPath=..\libiconv\libcharset\include\libcharset.h.in

"..\libiconv\libcharset\include\libcharset.h" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy ..\libiconv\libcharset\include\libcharset.h.in ..\libiconv\libcharset\include\libcharset.h
...
SOURCE="..\libiconv\libcharset\include\localcharset.h.msvc-shared"

!IF  "$(CFG)" == "libiconv - Win32 Debug"

# Begin Custom Build
InputPath=..\libiconv\libcharset\include\localcharset.h.msvc-shared

"..\libiconv\libcharset\include\localcharset.h" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy ..\libiconv\libcharset\include\localcharset.h.msvc-shared ..\libiconv\libcharset\include\localcharset.h
