 ...
 */
ODi_Style_Style* ODi_Office_Styles::addStyle(const XML_Char** ppAtts,
                                           ODi_ElementStack& rElementStack) {

    const XML_Char* pFamily;
    const XML_Char* pName;
    const XML_Char* pDisplayName;
 ...
 */
ODi_Style_PageLayout* ODi_Office_Styles::addPageLayout(const XML_Char** ppAtts,
                                                     ODi_ElementStack& rElementStack) {
    ...
    pStyle = new ODi_Style_PageLayout(rElementStack);
 ...
 */
ODi_Style_MasterPage* ODi_Office_Styles::addMasterPage(const XML_Char** ppAtts,
 ...
 * 
 */
ODi_Style_Style* ODi_Office_Styles::addDefaultStyle(const XML_Char** ppAtts,
                                                  ODi_ElementStack& rElementStack) {
 ...
 * 
 */
const ODi_Style_Style* ODi_Office_Styles::getTextStyle(const XML_Char* pStyleName,
                                              bool bOnContentStream) {
 ...
 * 
 */ 
const ODi_Style_Style* ODi_Office_Styles::getSectionStyle(const XML_Char* pStyleName,
                                                 bool bOnContentStream) {
 ...
 * 
 */
const ODi_Style_Style* ODi_Office_Styles::getGraphicStyle(const XML_Char* pStyleName,
                                          bool bOnContentStream) {
 ...
 * 
 */
const ODi_Style_Style* ODi_Office_Styles::getTableStyle(const XML_Char* pStyleName,
                                                  bool bOnContentStream) {
 ...
 */
ODi_Style_List* ODi_Office_Styles::addList(const XML_Char** ppAtts,
                                         ODi_ElementStack& rElementStack) {
    bool ok;
