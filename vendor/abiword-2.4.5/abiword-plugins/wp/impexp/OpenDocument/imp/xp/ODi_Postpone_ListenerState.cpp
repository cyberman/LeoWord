 ...
 * 
 */
void ODi_Postpone_ListenerState::startElement (const XML_Char* pName,
 ...
 * 
 */                        
void ODi_Postpone_ListenerState::endElement (const XML_Char* pName,
                                            ODi_ListenerStateAction& rAction) {
 ...
 * 
 */                      
void ODi_Postpone_ListenerState::charData (const XML_Char* pBuffer, int length) {
