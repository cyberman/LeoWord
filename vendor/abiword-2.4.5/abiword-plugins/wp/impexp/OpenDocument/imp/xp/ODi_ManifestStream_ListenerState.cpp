 ...
 */
void ODi_ManifestStream_ListenerState::startElement (const XML_Char* pName,
                                                const XML_Char** ppAtts,
                                                ODi_ListenerStateAction& rAction) 
{
    if (!UT_strcmp(pName, "manifest:encryption-data")) {
 ...
 */
void ODi_ManifestStream_ListenerState::endElement (const XML_Char* pName,
                                              ODi_ListenerStateAction& rAction)
{
    if (!UT_strcmp(pName, "manifest:manifest")) {
        rAction.popState();
    }
}
