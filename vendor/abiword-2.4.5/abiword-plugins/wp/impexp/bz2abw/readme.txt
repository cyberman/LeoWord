Please place libbz2.lib and bzlib.h in $(ABI_ROOT)/../libs/bzip2

libbz2.lib will need to be generated and copied to this location
for the Win32 plug-in build of bz2abw to work.
...
Alternately, Include directories may be created or mapped.
