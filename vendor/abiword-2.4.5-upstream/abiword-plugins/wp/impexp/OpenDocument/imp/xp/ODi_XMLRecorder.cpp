 ...
 * 
 */
void ODi_XMLRecorder::startElement (const XML_Char* pName,
 ...
 * 
 */                        
void ODi_XMLRecorder::endElement (const XML_Char* pName) {
 ...
 * 
 */                      
void ODi_XMLRecorder::charData (const XML_Char* pBuffer, int length) {
    CharDataCall* pCall;
