 ...
 * 
 */
void ODi_Style_PageLayout::startElement(const XML_Char* pName,
    ...
    if (!UT_strcmp("style:page-layout", pName)) {
        ...
        if (pVal) {
            if (!UT_strcmp(pVal,"0")) {  // see Bug 10076
                pVal = "1";
            }
            m_columnCount = pVal;
        }
    ...
    } else if (!UT_strcmp("style:header-footer-properties", pName)) {
 ...
 * 
 */
void ODi_Style_PageLayout::endElement(const XML_Char* pName,
                                     ODi_ListenerStateAction& rAction) {
 ...
 */
void ODi_Style_PageLayout::_parseHeaderFooterProperties(const XML_Char** ppAtts) {
 ...
 */
void ODi_Style_PageLayout::_parsePageLayoutProperties(const XML_Char** ppAtts) {
