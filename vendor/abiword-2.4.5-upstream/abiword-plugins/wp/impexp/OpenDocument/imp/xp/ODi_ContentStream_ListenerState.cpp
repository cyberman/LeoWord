 ...
 */
void ODi_ContentStream_ListenerState::startElement (const XML_Char* pName,
                                               ...
                                               ODi_ListenerStateAction& rAction)
{
    ...
    } else if (!UT_strcmp(pName, "office:body")) {
 ...
 *
 */
void ODi_ContentStream_ListenerState::endElement (const XML_Char* pName,
                                                ODi_ListenerStateAction& rAction)
{
    if (!UT_strcmp(pName, "office:document-content")) {
        // We're done.
        rAction.popState();
    }
}
