...
// Put it after Insert Picture in the Main menu
    ...
    XAP_Menu_Id newEquationID= pFact->addNewMenuAfter("Main",NULL,"&Endnote",EV_MLF_BeginSubMenu);
   UT_DEBUGMSG(("newEquationID %d \n",newEquationID));
    ...
    XAP_Menu_Id FromFileID= pFact->addNewMenuAfter("Main",NULL,AbiMathView_MenuLabelEquation,EV_MLF_Normal);
   ...
   XAP_Menu_Id FromLatexID= pFact->addNewMenuAfter("Main",NULL,AbiMathView_MenuLabelFileInsert,EV_MLF_Normal);
   ...
   XAP_Menu_Id endEquationID= pFact->addNewMenuAfter("Main",NULL,AbiMathView_MenuLabelLatexInsert,EV_MLF_EndSubMenu);
   UT_DEBUGMSG(("End Equation ID %d \n",endEquationID));
    pFact->addNewLabel(NULL,endEquationID,NULL,NULL);
