...
# PROP Output_Dir "..\abi\src\MSVC6_Debug\obj\expat"
# PROP Intermediate_Dir "..\abi\src\MSVC6_Debug\obj\expat"
# PROP Target_Dir ""
...
# ADD CPP /nologo /MDd /W3 /Gm /Gi /Zi /Od /Ob1 /Gy /I "..\expat\lib" /D "DEBUG" /D "_DEBUG" /D "_CTRDBG_MAP_ALLOC" /D "UT_DEBUG" /D "PT_TEST" /D "FMT_TEST" /D "UT_TEST" /D "_X86_" /D "WIN32" /D "COMPILED_FROM_DSP" /FR /GF /c
...
# ADD LIB32 /nologo /out:"..\abi\src\MSVC6_Debug\obj\libAbi_expat_s.lib"
...
# PROP Use_MFC 0
# PROP Use_Debug_Libraries 1
# PROP Output_Dir "..\abi\src\MSVC6_Release\obj\expat"
# PROP Intermediate_Dir "..\abi\src\MSVC6_Release\obj\expat"
# PROP Target_Dir ""
...
# ADD CPP /nologo /MD /W3 /Zi /O1 /Ob2 /I "..\expat\lib" /D "NDEBUG" /D "_X86_" /D "WIN32" /D "COMPILED_FROM_DSP" /GF /c
# ADD BASE RSC /l 0x41d
# ADD RSC /l 0x41d
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo /out:"..\abi\src\MSVC6_Debug\obj\libAbi_expat_s.lib"
# ADD LIB32 /nologo /out:"..\abi\src\MSVC6_Release\obj\libAbi_expat_s.lib"
...
SOURCE=..\expat\expat_config.h.msvc

!IF  "$(CFG)" == "expat - Win32 Debug"

# Begin Custom Build
InputPath=..\expat\expat_config.h.msvc

"..\expat\expat_config.h" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy ..\expat\expat_config.h.msvc ..\expat\expat_config.h
